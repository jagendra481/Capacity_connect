...
export const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" className="py-20 bg-slate-900/60 border-y border-slate-800/60 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-3 mb-16">
          ...
          <p className="text-sm text-slate-400 font-normal">
            A structured 5-step framework to transition from initial assessment to measurable organizational growth.
          </p>
        </div>

        {/* Desktop Minimal Timeline */}
        <div className="hidden lg:block relative">
          {/* Thin Connecting Line */}
          <div className="absolute top-7 left-10 right-10 h-0.5 bg-slate-800 z-0" />

          <div className="grid grid-cols-5 gap-4 relative z-10">
            {steps.map((step) => {
              const Icon = step.icon;
              return (
                <div key={step.num} className="flex flex-col items-center text-center space-y-3 group">
                  {/* Step Node */}
                  <div className="w-14 h-14 rounded-xl bg-slate-950 border border-slate-800 flex items-center justify-center shadow-sm group-hover:border-cyan-500/50 group-hover:scale-105 transition-all">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-400 leading-relaxed max-w-[190px] mx-auto font-normal">
                      {step.description}
                    </p>
                  </div>
                </div>
        ...
        <div className="lg:hidden relative space-y-6 max-w-md mx-auto">
          <div className="absolute top-4 bottom-4 left-5 w-0.5 bg-slate-800" />

          {steps.map((step) => {
            const Icon = step.icon;
            return (
              <div key={step.num} className="relative flex items-start space-x-4 pl-1">
                <div className="w-10 h-10 rounded-lg bg-slate-950 border border-slate-800 flex items-center justify-center z-10 flex-shrink-0">
